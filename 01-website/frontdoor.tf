...
# ================================================================================================
# Azure Front Door requires a TXT record (_dnsauth.www) to prove domain ownership
# before it can issue a Managed Certificate for HTTPS.
# This record is automatically populated with the validation token
# generated by the fd_custom_domain_www resource above.
# -----------------------------------------------------------------------------------------------
resource "azurerm_dns_txt_record" "afd_validation_www" {
  ...
  record {
    value = azurerm_cdn_frontdoor_custom_domain.fd_custom_domain_www.validation_properties[0].validation_token
  }
